...
?>
<div class="jinc_msg_title"><?php echo JText::_('MULTISUBSCRIPTION_RESULT'); ?></div>
<?php
if (isset($this->mmsg)) {
    ...
    if (count($this->mmsg) == 0) {
        echo '<div class="jinc_subscription_result">' . JText::_('MULTISUBSCRIPTION_RESULT_NO_NEWSLETTER_SELECTED') . '</div>';
    }
}
?>