...
?>
    ...
    function checkForm(subscriptionForm) {
        var notice_accept = subscriptionForm.notice_accept;
...
<div class="jinc_caption">
    ...
    <div class="jinc_commands">
        <!--
        <a class="jinc_messages" href="index.php?option=com_jinc&view=newsletter&news_id=<?php echo $news_id; ?>">
        <?php echo JText::_('LABEL_NEWS_DETAILS'); ?>
        </a>
        -->
    </div>
</div>
...
<form action="index.php" method="post" onSubmit="return checkForm(this);">
    <div class="jinc_frm_subscription">
        <table width="90%" border="0">
            ...
            $renderer = ($newsletter->get('input_style') == NEWSLETTER_INPUT_STYLE_MINIMAL)?
