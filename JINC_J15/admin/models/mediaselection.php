...
define('COM_MEDIA_BASE',    JPath::clean(JPATH_ROOT.DS.'images'));
define('COM_MEDIA_BASEURL', JURI::root(). 'images');
 ...
 * @since 1.5
 */
class JINCModelMediaselection extends JModel {
     ...
     */
    function getList() {
        jincimportext('helpers.media', 'com_media');
        static $list;
