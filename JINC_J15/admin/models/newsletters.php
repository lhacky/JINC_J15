...
class JINCModelNewsletters extends JModel {
    var $_data;
    /**
     * Items total
     * @var integer
    ...
    function _buildQuery() {
        ...
        $query = 'SELECT news_id, news_name, published, ' .
            'UNIX_TIMESTAMP(news_lastsent) AS news_lastsent, ' .
            'UNIX_TIMESTAMP(news_created) AS news_created, ' .
            'news_sendername, news_senderaddr, news_type ' .
