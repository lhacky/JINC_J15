...
class JINCModelNotices extends JModel {
    var $_data;
    /**
     * Items total
     * @var integer
    ...
    function __construct() {
        ...
        $filter_order     = $mainframe->getUserStateFromRequest($context.'.filter_order', 'filter_order', 'noti_name', 'string' );        
    ...
    function _buildQuery() {
        ...
        $query = 'SELECT t.noti_id, t.noti_name, t.noti_title, t.noti_bdesc '.
            'FROM #__jinc_notice t';
