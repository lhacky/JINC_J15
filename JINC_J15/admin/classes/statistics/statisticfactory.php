...
class StatisticFactory {
    ...
    function getTypeList() {
        ...
        $typelist[1] = array('stat_type' => STATISTICFACTORY_SUBS_TYPE, 'stat_descr' => JText::_('OPTION_SUBS_TYPE'));
        $typelist[2] = array('stat_type' => STATISTICFACTORY_UNSUBS_TYPE, 'stat_descr' => JText::_('OPTION_UNSUBS_TYPE'));
        $typelist[3] = array('stat_type' => STATISTICFACTORY_SENT_TYPE, 'stat_descr' => JText::_('OPTION_SENT_TYPE'));
        return $typelist;
    }
    ...
    function getTimeList() {
        $timelist = array();
        $timelist[0] = array('time_type' => STATISTICFACTORY_STAT_HOURLY, 'time_descr' => JText::_('OPTION_STAT_HOURLY'));
        $timelist[1] = array('time_type' => STATISTICFACTORY_STAT_DAILY, 'time_descr' => JText::_('OPTION_STAT_DAILY'));
        // $timelist[2] = array('time_type' => STATISTICFACTORY_STAT_WEEKLY, 'time_descr' => JText::_('OPTION_STAT_WEEKLY'));
        // $timelist[3] = array('time_type' => STATISTICFACTORY_STAT_MONTHLY, 'time_descr' => JText::_('OPTION_STAT_MONTHLY'));
        return $timelist;
    }
}
?>