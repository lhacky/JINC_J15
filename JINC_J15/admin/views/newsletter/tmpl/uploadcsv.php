...
JINCHTMLHelper::hint('IMPORT', 'IMPORT_TITLE', '', $csv_string);
...
<form action="index.php" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
    <table class="adminform">
        <tr>
            <th colspan="2"><?php echo JText::_( 'PANEL_LOAD_CSVFILE' ); ?></th>
        </tr>
        <tr>
            <td width="120">
                <label for="install_package">
                    <?php echo JText::_( 'INPUT_LOAD_CSVFILE' ); ?>
                </label>
            </td>
            <td>
                <input type="file" name="csvfile" id="csvfile" size="57" />
                <input type="submit" value="<?php echo JText::_('BTN_UPLOAD_AND_IMPORT'); ?>">
            </td>
        </tr>
    </table>
