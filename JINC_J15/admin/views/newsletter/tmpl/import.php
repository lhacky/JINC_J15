...
<table align="center" class="adminform">
    <tr>
        <th><?php echo JText::_( 'COL_TITLE_IMPORT_INFO' ); ?></th>
        <th><?php echo JText::_( 'COL_TITLE_RESULT' ); ?></th>
    </tr>
    ...
    if (isset ($this->result)) {
        ...
        for ($i = 0 ; $i < count($results) ; $i++) {
            ...
            $value = $result['result'];
            if ($value == 'OK') {
                echo '<img src="images/apply_f2.png" alt="OK" width="16px" height="16px">';
            } else {
                echo '<img src="images/cancel_f2.png" alt="OK" width="16px" height="16px">';
            }
            echo '&nbsp;&nbsp;' . JText::_($value);
            echo '</td>';
