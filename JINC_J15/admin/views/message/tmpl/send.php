    ...
    function getStatusString(status) {
        switch(status) {
            case "<?php echo PROCESS_STATUS_RUNNING; ?>":
                    return "<?php echo JText::_('LEGEND_MESSAGE_RUNNING'); ?>";
                break;
            case "<?php echo PROCESS_STATUS_PAUSED; ?>":
                    return "<?php echo JText::_('LEGEND_MESSAGE_PAUSED'); ?>";
                break;
            case "<?php echo PROCESS_STATUS_FINISHED; ?>":
                    return "<?php echo JText::_('LEGEND_MESSAGE_FINISHED'); ?>";
                break;
            case "<?php echo PROCESS_STATUS_STOPPED; ?>":
                    return "<?php echo JText::_('LEGEND_MESSAGE_STOPPED'); ?>";
                break;
            default:
                return "";
            }
        ...
        function inProgress() {
            alert('<?php echo JText::_('JS_WARN_SEND_INPROGRESS'); ?>');
        }

        function sendMessage() {
            msg_id = '<?php echo isset($this->msgid)? $this->msgid:''; ?>';
            var nowdate = new Date();
            ...
            return plx.ExternalRequest({
                'content_type': 'json',
                'url': 'index.php?option=com_jinc&controller=message&task=send&format=raw',
                ...
                'params':{'msgid': msg_id, 'cache_id': cache_id, 'client_id': client_id}
            });
        }
        ...
        function pause() {
            ...
            return plx.ExternalRequest({
                'content_type': 'json',
                'url': 'index.php?option=com_jinc&controller=message&task=pause&format=raw',
                'onFinish': function(response){
                    var status            = response.status;
                ...
                'params':{'msgid': msg_id, 'cache_id': cache_id}
            });
        }
        ...
        function stop() {
            ...
            return plx.ExternalRequest({
                'content_type': 'json',
                'url': 'index.php?option=com_jinc&controller=message&task=stop&format=raw',
                'onFinish': function(response){
                    var status            = response.status;
    ...
    <center>
        <table align="center" width="35%" border=0 class="adminlist">
            <thead>
                <tr>
                    <td width="100%" colspan="4" align="center">
                        <strong><?php echo JText::_( 'LABEL_LAST_RESPONSE_DATA' ) ; ?></strong>
                    </td>
                </tr>
            </thead>
            ...
            <tr>
                            ...
                            if (isset ($this->proc_status)) {
                                switch ($this->proc_status) {
                                    case PROCESS_STATUS_FINISHED:
                                        echo JText::_('LEGEND_MESSAGE_FINISHED');
                                        break;

                                    case PROCESS_STATUS_PAUSED:
                                        echo JText::_('LEGEND_MESSAGE_PAUSED');
                                        break;

                                    case PROCESS_STATUS_RUNNING:
                                        echo JText::_('LEGEND_MESSAGE_RUNNING');
                                        break;

                                    case PROCESS_STATUS_STOPPED:
                                        echo JText::_('LEGEND_MESSAGE_STOPPED');
                                        break;
                ...
                <td width="25%" align="left">
                    <?php echo JText::_( 'LABEL_SENT_MESSAGES' ) ; ?>
                </td>
                <td width="25%" align="right">
                    <strong>
            ...
            <tr>
                <td width="25%" align="left">
                    <?php echo JText::_( 'LABEL_LAST_RESPONSE' ) ; ?>
                </td>
                <td width="25%" align="right">
                    <strong>
                ...
                <td width="25%" align="left">
                    <?php echo JText::_( 'LABEL_SENT_SUCCESS' ) ; ?>
                </td>
                <td width="25%" align="right">
                    <strong>
                        <span id='sentSuccess'>
            ...
            <tr>
                <td width="25%" align="left">
                    <?php echo JText::_( 'LABEL_START_TIME' ) ; ?>
                </td>
                <td width="25%" align="right">
                    <strong>
                        <span id='startTime'>
                ...
                <td width="25%" align="left">
                    <?php echo JText::_( 'LABEL_TOT_RECIPIENTS' ) ; ?>
                </td>
                <td width="25%" align="right">
                    <strong>
            ...
            <tr>
                <td width="25%" align="left">
                    <?php echo JText::_( 'LABEL_ERROR_MSG' ) ; ?>
                </td>
        ...
        <?php echo JText::_( 'LABEL_PROGRESS' ); ?> <span id='progressBar'>0%</span><br>
        ...
        <table align="center" width="50%" cellspacing="15px">
            <tr>
                <td align="center">
                    <div class="jinc_send">
                        <img title="<?php echo JText::_( 'TITLE_PLAY' ) ; ?>" id="btnPlay" width="48px" src="components/com_jinc/assets/images/icons/play.png" alt="play" onClick="updateClientId(); sendMessage();">
                    </div>
                </td>
                <td align="center">
                    <div class="jinc_send">
                        <img title="<?php echo JText::_( 'TITLE_PAUSE' ) ; ?>" id="btnPause" width="48px" src="components/com_jinc/assets/images/icons/pause.png" alt="play" onClick="pause();">
                    </div>
                </td>
                <td align="center">
                    <div class="jinc_send">
                        <img title="<?php echo JText::_( 'TITLE_STOP' ) ; ?>" id="btnStop" width="48px" src="components/com_jinc/assets/images/icons/stop.png" alt="play" onClick="stop();">
                    </div>
                </td>
                <td align="center">
                    <div class="jinc_send">
                        <img title="<?php echo JText::_( 'TITLE_BACK' ) ; ?>" id="btnBack" width="48px" src="components/com_jinc/assets/images/icons/back.png" alt="play" onClick="back();">
                    </div>
                </td>
            </tr>
        </table>
